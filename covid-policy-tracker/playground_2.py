...
policies_oh_single_policy.to_csv("CCCSL_policies_onehot_full_wo_Germany_absolute_R.csv")
...
policies_oh_full.to_csv("CCCSL_policies_onehot_full_absolute_R.csv")

create_policies_oh(features, responses, "Germany", False).to_csv("CCCSL_policies_onehot_Germany_absolute_R.csv")
